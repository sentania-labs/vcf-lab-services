...
and fresh volumes. It publishes HTTPS and SFTP only on Docker-assigned loopback
...
to return an SSH banner. It also starts the complete Compose appliance with
